...
object DummyData {
    val workoutTrainings = listOf(
        ...
        WorkoutTraining(4, "Custom Push-Up", R.drawable.get_started, "Push up: Latihan tubuh atas tanpa peralatan. Menguatkan dada, bahu, dan trisep. Sederhana dan dapat dilakukan di mana saja.", 90, null),
    )
